const fs = require('fs');
let c = fs.readFileSync('src/lib/data/destinations.js', 'utf8');
...
fs.writeFileSync('src/lib/data/destinations.js', c, 'utf8');
console.log(`Fixed ${count}/8 destination SEO entries`);
