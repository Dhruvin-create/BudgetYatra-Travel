        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/blogs"
                className="inline-flex items-center px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-full transition-colors shadow-lg"
              >
                Explore Guides
              ...
              <Link
                href="/contact"
                className="inline-flex items-center px-8 py-4 bg-white border-2 border-primary-600 text-primary-600 hover:bg-primary-50 font-semibold rounded-full transition-colors"
              >
                Get in Touch
              </Link>
            </div>
