...
export default function Footer() {
  ...
  const popularGuides = [
    { name: 'Beach Destinations', href: '/blogs?category=Beach' },
    { name: 'Mountain Getaways', href: '/blogs?category=Mountains' },
    { name: 'Heritage Sites', href: '/blogs?category=Heritage' },
    { name: 'Adventure Travel', href: '/blogs?category=Adventure' }
  ];

  const travelTips = [
    { name: 'Budget Planning', href: '/calculator', id: 'budget-planning' },
    { name: 'Best Time to Visit', href: '/guide', id: 'best-time' },
    { name: 'Packing Tips', href: '/blogs?q=packing', id: 'packing-tips' },
    { name: 'Travel Safety', href: '/blogs?q=safety', id: 'travel-safety' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold bg-linear-to-r from-primary-400 to-secondary-400 bg-clip-text text-transparent mb-4">
              BudgetYatra
            </h3>
          ...
          {/* Travel Tips */}
          <div>
            <h4 className="text-lg font-semibold mb-4">Travel Tips</h4>
            <ul className="space-y-2">
              {travelTips.map((tip) => (
                <li key={tip.id}>
                  <Link
